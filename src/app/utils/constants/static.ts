...
export const App_url = {
  ...
  image: {
    ...
    pdfImage: `${window.location.origin}/assets/images/pdfImage.svg`,
    picture: `${window.location.origin}/assets/images/picture.svg`,
    pause: `${window.location.origin}/assets/icons/pause.svg`,
    editinvoice: `${window.location.origin}/assets/icons/edit-invoice.svg`,
    addplus: `${window.location.origin}/assets/icons/addplus.svg`,
    stop: `${window.location.origin}/assets/icons/stop.svg`,
    start: `${window.location.origin}/assets/icons/start.svg`,
    ...
    truck1: `${window.location.origin}/assets/icons/truck1.svg`,
    excel: `${window.location.origin}/assets/icons/excel.svg`,
    fullscreen: `${window.location.origin}/assets/icons/fullscreen.svg`,
    fullscreenexit: `${window.location.origin}/assets/icons/fullscreenexit.svg`,
    FileSave: `${window.location.origin}/assets/icons/FileSave.svg`,
    backgroundImage: `${window.location.origin}/assets/icons/Login.png`,
    coverImage: `${window.location.origin}/assets/icons/coverimg.png`,
    arrowleft: `${window.location.origin}/assets/icons/arrowleft.svg`,
    ...
    SendMsg: `${window.location.origin}/assets/icons/SendMsg.svg`,
    ...
    FileUpload: `${window.location.origin}/assets/icons/CloudArrowUp.svg`,
    FileUpload1: `${window.location.origin}/assets/icons/FileUpload.svg`,
    ...
    attahment: `${window.location.origin}/assets/icons/attachment.svg`,
    ...
    emoji: `${window.location.origin}/assets/icons/Emoji.webp`,
    ...
    circlePlusIcon: `${window.location.origin}/assets/icons/circlePlusIcon.svg`,
    TrashIcon: `${window.location.origin}/assets/icons/TrashIcon.svg`,
    downloadBtnIcon: `${window.location.origin}/assets/icons/downloadBtnIcon.svg`,
    eyeBtnIcon: `${window.location.origin}/assets/icons/eyeBtnIcon.svg`,
    sendIcon: `${window.location.origin}/assets/icons/sendIcon.svg`,
    filterFill: `${window.location.origin}/assets/icons/filterFill.svg`,
    close: `${window.location.origin}/assets/icons/close.svg`,
    hide: `${window.location.origin}/assets/icons/hide.svg`,
    show: `${window.location.origin}/assets/icons/show.svg`,
    infoIcon: `${window.location.origin}/assets/icons/infoIcon.svg`,
    ExcelIcon: `${window.location.origin}/assets/icons/ExcelIcon.svg`,
    PencilSimple: `${window.location.origin}/assets/icons/PencilSimple.svg`,
    UserIcon: `${window.location.origin}/assets/icons/UserIcon.svg`,
    Briefcase: `${window.location.origin}/assets/icons/Briefcase.svg`,
    HashStraight: `${window.location.origin}/assets/icons/HashStraight.svg`,
    profile: `${window.location.origin}/assets/icons/profile.svg`,
    card1: `${window.location.origin}/assets/icons/card1.png`,
    card2: `${window.location.origin}/assets/icons/card2.png`,
    card3: `${window.location.origin}/assets/icons/card3.png`,
    card4: `${window.location.origin}/assets/icons/card4.png`,

    dashboard: `${window.location.origin}/assets/icons/dashboard.svg`,
    college_management: `${window.location.origin}/assets/icons/college-management.svg`,
    student_management: `${window.location.origin}/assets/icons/student-management.svg`,
    master_management: `${window.location.origin}/assets/icons/master-management.svg`,
    payments: `${window.location.origin}/assets/icons/master-management.svg`,
    news: `${window.location.origin}/assets/icons/news.svg`,
    notification: `${window.location.origin}/assets/icons/notification.svg`,
    admission: `${window.location.origin}/assets/icons/admissions.svg`,
    college_master: `${window.location.origin}/assets/icons/college_master.svg`,
    college_cutoff: `${window.location.origin}/assets/icons/college_cutoff.svg`,
    log: `${window.location.origin}/assets/icons/log.svg`,
    down: `${window.location.origin}/assets/icons/down.svg`,
    admin: `${window.location.origin}/assets/icons/admin.png`,
    search_i: `${window.location.origin}/assets/icons/search_i.svg`,
    package: `${window.location.origin}/assets/icons/package.svg`,
    ug: `${window.location.origin}/assets/icons/ug.svg`,
    category: `${window.location.origin}/assets/icons/category.svg`,
    district: `${window.location.origin}/assets/icons/district.svg`,
    board_exam: `${window.location.origin}/assets/icons/board_exam.svg`,
...
export const INITIAL_PERMISSION = 'userService:changePassword,emailTemplateService:list,emailTemplateService:get,cityService:list,stateService:list,countryService:list,userService:updateColumnPermission'
export const adminsidebarcontent = [
  {
    title: "Dashboard",
    route: App_url.link.DASHBOARD_URL,
    icon: App_url.image.dashboard,
  },
  {
    title: "College Management",
    icon: App_url.image.college_management,
    children: [
      {
        title: "Colleges Master",
